...
`src\computing` -- дополнительные материалы для подмодуля `computation_template`, автоматический последовательный запуск всех этапов работы с нидингами и других задач  
